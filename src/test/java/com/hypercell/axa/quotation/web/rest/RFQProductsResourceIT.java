...
class RFQProductsResourceIT {
    ...
    void createRFQProducts() throws Exception {
        ...
        assertThat(testRFQProducts.getLineTypeId()).isEqualTo(DEFAULT_LINE_TYPE_ID);
        assertThat(testRFQProducts.getCoverType()).isEqualTo(DEFAULT_COVER_TYPE);
        assertThat(testRFQProducts.getCategories()).isEqualTo(DEFAULT_CATEGORIES);
    }
    ...
    void putNewRFQProducts() throws Exception {
        ...
        assertThat(testRFQProducts.getLineTypeId()).isEqualTo(UPDATED_LINE_TYPE_ID);
        assertThat(testRFQProducts.getCoverType()).isEqualTo(UPDATED_COVER_TYPE);
        assertThat(testRFQProducts.getCategories()).isEqualTo(UPDATED_CATEGORIES);
    }
    ...
    void partialUpdateRFQProductsWithPatch() throws Exception {
        ...
        partialUpdatedRFQProducts.lineTypeId(UPDATED_LINE_TYPE_ID).coverType(UPDATED_COVER_TYPE);
