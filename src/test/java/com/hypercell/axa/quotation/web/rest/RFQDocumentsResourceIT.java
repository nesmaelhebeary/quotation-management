...
class RFQDocumentsResourceIT {
    ...
    void createRFQDocuments() throws Exception {
        ...
        assertThat(testRFQDocuments.getRfqId()).isEqualTo(DEFAULT_RFQ_ID);
    ...
    void putNewRFQDocuments() throws Exception {
        ...
        RFQDocuments testRFQDocuments = rFQDocumentsList.get(rFQDocumentsList.size() - 1);
        assertThat(testRFQDocuments.getRfqId()).isEqualTo(UPDATED_RFQ_ID);
    ...
    void partialUpdateRFQDocumentsWithPatch() throws Exception {
        ...
        partialUpdatedRFQDocuments.rfqId(UPDATED_RFQ_ID).documentPath(UPDATED_DOCUMENT_PATH).documentName(UPDATED_DOCUMENT_NAME);
