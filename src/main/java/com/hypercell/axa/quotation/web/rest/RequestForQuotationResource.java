        ...
        Optional<RequestForQuotation> result = requestForQuotationRepository
            ...
            .map(
                existingRequestForQuotation -> {
                    ...
                    if (requestForQuotation.getPolicyType() != null) {
                        existingRequestForQuotation.setPolicyType(requestForQuotation.getPolicyType());
                    }
                    ...
                    if (requestForQuotation.getNumberOfMonth() != null) {
                        existingRequestForQuotation.setNumberOfMonth(requestForQuotation.getNumberOfMonth());
                    }
