        ...
        Optional<RFQProductsSections> result = rFQProductsSectionsRepository
            ...
            .map(
                existingRFQProductsSections -> {
                    ...
                    if (rFQProductsSections.getSectionId() != null) {
                        existingRFQProductsSections.setSectionId(rFQProductsSections.getSectionId());
                    }
                    if (rFQProductsSections.getTurnOver() != null) {
                        existingRFQProductsSections.setTurnOver(rFQProductsSections.getTurnOver());
                    }
                    if (rFQProductsSections.getMaxPerTime() != null) {
                        existingRFQProductsSections.setMaxPerTime(rFQProductsSections.getMaxPerTime());
                    }
