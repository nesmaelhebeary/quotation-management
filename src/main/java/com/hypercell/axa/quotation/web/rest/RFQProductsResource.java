        ...
        Optional<RFQProducts> result = rFQProductsRepository
            ...
            .map(
                existingRFQProducts -> {
                    ...
                    if (rFQProducts.getLineTypeId() != null) {
                        existingRFQProducts.setLineTypeId(rFQProducts.getLineTypeId());
                    }
                    if (rFQProducts.getCoverType() != null) {
                        existingRFQProducts.setCoverType(rFQProducts.getCoverType());
                    }
                    if (rFQProducts.getCategories() != null) {
                        existingRFQProducts.setCategories(rFQProducts.getCategories());
                    }
